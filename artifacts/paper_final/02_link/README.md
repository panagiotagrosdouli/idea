...
`link_verification.json` records the fail-closed Stage 2 verification result and the SHA-256 digest of the LUT. Absolute received power remains normalized/model-based; this artifact does not claim a measured optical channel.
