#!/usr/bin/env python3
"""Run the frozen synthetic operating-region sweep."""
...
from predictive_pc_fmcw.synthetic.operating_region import run_operating_region_sweep
...
def main() -> None:
    ...
    output_dir = args.output_dir or (
        f"artifacts/synthetic_dataset_v1/operating_region_{args.split}"
    )
    report = run_operating_region_sweep(
        args.dataset,
        split=args.split,
